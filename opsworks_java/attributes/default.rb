...
if rhel7?
  ...
  default['opsworks_java']['tomcat']['catalina_base_dir'] = "/opt/tomcat"
  default['opsworks_java']['tomcat']['webapps_base_dir'] = "/opt/tomcat/webapps"
  default['opsworks_java']['tomcat']['lib_dir'] = "/opt/tomcat/lib"
end
...
default['opsworks_java']['tomcat']['java_shared_lib_dir'] = '/usr/bin/java'
